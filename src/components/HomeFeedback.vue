<template>
  <section class="feedback">
    <h2 class="feedback__title">Мы всегда вам рады!</h2>
    <div class="feedback__block">
      <div class="feedback__left">
        <div class="feedback__left__text">
          ...
          <tippy content="Реплицированные с зарубежных источников, исследования формируют глобальную сеть.">
            <button class="tippy__btn">
        ...
        <form action="#" class="feedback__left__form">
          <label for="name">
            <input id="name" type="text" placeholder="Как вас зовут?" class="feedback__left__form__input" required>
          </label>
          <label for="phone">
            <input id="phone" type="tel" placeholder="Ваш телефон" class="feedback__left__form__input" minlength="11"
              maxlength="11" pattern="[0-9]*" required>
          </label>
          <label for="email">
            <input id="email" type="email" placeholder="Ваш e-mail" class="feedback__left__form__input" required>
          </label>
          <div class="feedback__left__form__bottom">
            <button class="btn1 feedback__left__form__btn">Отправить</button>
            <label for="">
              <input type="checkbox" id="checkbox" required class="checkbox">
              <label for="checkbox" class="checkbox__label">
                Принимаю
                <a href="#" class="feedback__left__form__bottom__link">пользовательское соглашение</a>
              </label>
            </label>
          </div>
        </form>
      </div>
      <div class="feedback__right"></div>
    </div>
  </section>
</template>
