<template>
  <section class="hight-rating">
    <h2 class="hight-rating__title">Высокий рейтинг</h2>
    <div class="hight-rating__block">
      <div class="hight-rating__block__card hight-rating__block__card-nth" v-for="item in rating" :key="item.id">
    ...
    <button class="btn1 hight-rating__btn">Смотреть больше товаров</button>
  </section>
</template>
